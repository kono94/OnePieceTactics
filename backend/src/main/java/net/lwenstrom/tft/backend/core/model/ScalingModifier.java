...
public record ScalingModifier(ScalingType scalingType, float factor) implements AbilityModifier {
    ...
    // 50% increase)
    public float calculateMultiplier(GameUnit caster, GameUnit target) {
